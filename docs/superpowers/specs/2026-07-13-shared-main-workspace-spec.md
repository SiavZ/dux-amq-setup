<!-- Ported verbatim from fork main PLAN.md (spec 79ad41d3, revised through the shared-workspace phases). File and line references point at the fork's old src/ layout. The port onto the crates layout is described in docs/shared-workspace.md. -->
